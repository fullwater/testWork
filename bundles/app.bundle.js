...
const ngRoute = __webpack_require__(3);
...
(function (window, angular) {
  ...
  var ngRouteModule = angular.module('ngRoute', []).info({ angularVersion: '1.6.8' }).provider('$route', $RouteProvider).
...
function HomeController($scope, $http, $rootScope) {
    ...
    $scope.auth = function () {
        $http({
            method: "get",
            url: "http://localhost:3001/login/facebook"
